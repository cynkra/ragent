...
```{r}
#| eval: false
# Let's start with something tricky

llm_chat("What date is it?")



agent_calculator("What is 0.1 + 0.2?")
#> The result is exactly 0.3
#>
#> Note: While many systems struggle with floating point precision
#> (try this in JavaScript!), R handles this calculation correctly.
...
The best part? It's all running right there on your machine. No cloud needed, no API keys to manage - just pure local LLM goodness! 🚀
